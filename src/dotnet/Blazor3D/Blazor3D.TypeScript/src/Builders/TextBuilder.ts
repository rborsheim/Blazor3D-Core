// there were issues with this file so it is currently commented out because we don't use it
...
//          const material = MaterialBuilder.buildMaterials(options.materials)[0];
...
//          const matDark : any = new THREE.MeshBasicMaterial({
//            color: options.materials[0].color,
