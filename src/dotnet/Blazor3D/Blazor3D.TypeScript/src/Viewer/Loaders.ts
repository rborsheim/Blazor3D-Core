// this had problems so it is commented out - it isn't currently used
...
//      //   color: 0xff5533,
//      // });
//      const  material = MaterialBuilder.buildMaterials(materialSettings)[0];
...
//static callDotNet(containerId: string, uuid: string): void {
...
//      uuid
//    ).then(result => {
//        // Handle result or success scenario
//    }).catch(error => {
