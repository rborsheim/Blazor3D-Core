namespace HomagGroup.Blazor3D.Configuration
{
    ...
    /// </summary>
    /// <inheritdoc><see cref="CameraOptions"/></inheritdoc>
    public sealed class PerspectiveCameraOptions : CameraOptions
    {
        public PerspectiveCameraOptions() : base(ObjectTypes.PerspectiveCamera)
        {
        }
        ...
        public PerspectiveCameraOptions(double fov, double near, double far) : this()
        {
            Fov = fov;
            Near = near;
            Far = far;
