namespace HomagGroup.Blazor3D.Configuration
{
    ...
    /// </summary>
    public sealed class OrthographicCameraOptions : CameraOptions
    {
        public OrthographicCameraOptions() : base(ObjectTypes.OrthographicCamera)
        {
        ...
        public OrthographicCameraOptions(double left = -1, double right = 1, double top = 1, double bottom = -1, double near = 0.1, double far = 2000, double zoom = 1) : this()
        {
            Left = left;
            Right = right;
            Top = top;
